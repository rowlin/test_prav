                    ...
                    <div class="row">
                        ...
                        <div class="table-responsive_2">
                            <table class="w_100">
                                ...
                                <tr class="ul_pole_uchastnicov_2_2" style="display: none">
                                    <td class="border-r_b_2 txt_al_ct">
                                        <div class="file_2">
                                            <input disabled type="text" name="date" id="date" placeholder="Дата" value="">
                                        </div>
                                    </td>
                                    <td class="border-r_b_2 txt_al_ct">
                                        <div class="file_2">
                                            <input disabled type="text" name="weight" id="weight" placeholder="Вес" value="">
                                        </div>
                                    </td>
                                    <td class="border-r_b_2 txt_al_ct">
                                        <div class="file_2">
                                            <input disabled type="text" name="waist" id="waist" placeholder="Объем талии" value="">
                                        </div>
                                    </td>
                                    <td class="border-r_b_2 txt_al_ct">
                                        <div class="file_2">
                                            <input disabled type="text" name="chest" id="chest" placeholder="Объем груди" value="">
                                        </div>
                                    </td>
                                    <td class="txt_al_ct">
                                        <div class="file_2">
                                            <input disabled type="text" name="hip" id="hip" placeholder="Обхват бедра" value="">
                                        </div>
                                    </td>
                                </tr>
                            </table>
                        ...
                        <div class="">
                            <div class="button_div_2">
                                <button id="addSize" class="button_2">
